                    ...
                    <form method="POST" action="/config/fLogin.php">
                        <div class="form__line"><i class="fa-solid fa-file-signature"></i></i>
                            <select id="contrato" name="contrato" placeholder="Selecione contrato" required="required">
                                <option value="0">Contrato(27119) - rua maracanã - Nº160 - residencial viena</option>
                                <option value="1">Contrato(48349) - rua manilio gobbi - Nº313 - centro</option>
                            </select></div>
                        <div class="form__line"><button type="submit">Selecionar Contrato</button></div>
                    </form>
                    <style>
                        .container__login{
                            width: 50% !important;
