        ...
        <div class="container__login">
            ...
            <div class="container__login-mid">
                <div class="form__logins">
                    <form method="POST" action="../controller/contrato_selecionado.php">
                        <div class="form__line"><i class="fa-solid fa-file-signature"></i></i>
                            ...
                            <?php
                                $array = Contratos::listar_contratos($_SESSION['cpf']);
                        ...
                        <div class="form__line"><button type="submit" name="ph_confirmar">Selecionar Contrato</button></div>
                    </form>
                    <style>
                        .container__login{
                            width: 50% !important;
